      ...
      <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
        <div class="col-md-4">
          <div class="card card-blog">
            <div class="card-img" >
              <a href="members.php?member=<?=$row['name'] ?>"><img src="<?php echo empty($row['photo']) ?"img/post-1.jpg" : "images/".$row['photo']?>" 
                            alt="" class="img-fluid"style="object-fit:contain ; max-width:100% ; max-height:100%" ></a>
            </div>
            <div class="card-body">
              <div class="card-category-box">
                <div class="card-category">
                  <h6 class="category"><?=$row['position'] ?></h6>
                </div>
              </div>
              <h3 class="card-title"><a href="members.php?member=<?=$row['name'] ?>"><?=$row['name'] ?></a></h3>
              <p class="card-description">
              <?php echo $row['uni']." - ".$row['faculty']  ?>
              </p>
            </div>
